...
resource "aws_s3_bucket" "terraform_state" {
  ...
  # get Error : The bucket you tried to delete is not empty. You must delete all versions in the bucket
...
# 如何部署，第一步驟: 以 local backend 部署 s3 跟 DynammoDB table
# terraform {
#   backend "local" {
#   }
# }

# 如何部署，第二步驟: 加上 remote backend
